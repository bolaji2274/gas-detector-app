...
void main() {
  ...
  testWidgets('GasGauge displays correct PPM value and gauge', (WidgetTester tester) async {
  ...
  testWidgets('QuickStats shows "High" status for 600 PPM', (WidgetTester tester) async {
  ...
  testWidgets('DeviceCard shows green indicator when online', (WidgetTester tester) async {
    // Mock your Device model here
    final onlineDevice = Device(name: "Kitchen", isOnline: true, location: "Main House");
